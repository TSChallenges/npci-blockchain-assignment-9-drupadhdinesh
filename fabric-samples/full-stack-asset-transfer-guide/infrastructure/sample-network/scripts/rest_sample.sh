...
export ORG=Rbi
export USERNAME=Hdfcuser
export PASSWORD=Rbiuser
...
CONFIG_DIR=${TEMP_DIR}/fabric-rest-sample-config 
  ...
  local ca_pem=$ENROLLMENT_DIR/Rbi/users/$USERNAME/msp/signcerts/cert.pem
  local keyPath=$ENROLLMENT_DIR/Rbi/users/$USERNAME/msp/keystore/key.pem
