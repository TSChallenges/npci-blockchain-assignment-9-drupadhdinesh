...
// const keyPath = WORKSHOP_CRYPTO + "/enrollments/Rbi/users/Rbiuser/msp/keystore/key.pem";
// const certPath = WORKSHOP_CRYPTO + "/enrollments/Rbi/users/Rbiuser/msp/signcerts/cert.pem"
// const tlsCertPath = WORKSHOP_CRYPTO + "/channel-msp/peerOrganizations/Rbi/msp/tlscacerts/tlsca-signcert.pem";
...
const peerEndpoint = "test-network-Rbi-peer1-peer.localho.st:443";
const peerHostAlias = "test-network-Rbi-peer1-peer.localho.st";
