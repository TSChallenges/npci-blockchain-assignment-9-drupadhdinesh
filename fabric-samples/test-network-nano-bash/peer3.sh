...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/Hdfc.example.com/peers/peer0.Hdfc.example.com/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/Hdfc.example.com/peers/peer0.Hdfc.example.com/tls/server.key
export CORE_PEER_TLS_ROOTCERT_FILE="${PWD}"/crypto-config/peerOrganizations/Hdfc.example.com/peers/peer0.Hdfc.example.com/tls/ca.crt
export CORE_PEER_ID=peer0.Hdfc.example.com
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/Hdfc.example.com/peers/peer0.Hdfc.example.com/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8448
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer0.Hdfc.example.com
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer0.Hdfc.example.com/snapshots
