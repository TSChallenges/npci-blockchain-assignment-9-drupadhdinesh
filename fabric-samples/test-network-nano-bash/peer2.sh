...
export CORE_PEER_TLS_CERT_FILE="${PWD}"/crypto-config/peerOrganizations/Rbi.example.com/peers/peer1.Rbi.example.com/tls/server.crt
export CORE_PEER_TLS_KEY_FILE="${PWD}"/crypto-config/peerOrganizations/Rbi.example.com/peers/peer1.Rbi.example.com/tls/server.key
export CORE_PEER_TLS_ROOTCERT_FILE="${PWD}"/crypto-config/peerOrganizations/Rbi.example.com/peers/peer1.Rbi.example.com/tls/ca.crt
export CORE_PEER_ID=peer1.Rbi.example.com
...
export CORE_PEER_MSPCONFIGPATH="${PWD}"/crypto-config/peerOrganizations/Rbi.example.com/peers/peer1.Rbi.example.com/msp
export CORE_OPERATIONS_LISTENADDRESS=127.0.0.1:8447
export CORE_PEER_FILESYSTEMPATH="${PWD}"/data/peer1.Rbi.example.com
export CORE_LEDGER_SNAPSHOTS_ROOTDIR="${PWD}"/data/peer1.Rbi.example.com/snapshots
