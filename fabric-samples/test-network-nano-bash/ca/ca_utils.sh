...
createEnrollment() {
  ...
  local orgname=$4          # name of the org (e.g. Rbi, Hdfc)  can be blank
...
createMSP() {
  ...
  local caname=$1       # name of the ca (ordererca, Rbica, Hdfcca)
  local orgname=$2      # name of the org (Rbi, Hdfc)  Ordering Org is blank
...
registerAndEnroll() {
  ...
  local orgname=$5           # name of the org (e.g. Rbi, Hdfc)  can be blank
