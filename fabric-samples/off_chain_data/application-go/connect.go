...
var (
	...
	mspID         = envOrDefault("MSP_ID", "RbiP")

	// Path to crypto materials.
	cryptoPath = envOrDefault("CRYPTO_PATH", "../../test-network/organizations/peerOrganizations/Rbiexample.com")

	// Path to user private key directory.
	keyDirectoryPath = envOrDefault("KEY_DIRECTORY_PATH", cryptoPath+"/users/User1@Rbiexample.com/msp/keystore")

	// Path to user certificate.
	certPath = envOrDefault("CERT_PATH", cryptoPath+"/users/User1@Rbiexample.com/msp/signcerts/cert.pem")

	// Path to peer tls certificate.
	tlsCertPath = envOrDefault("TLS_CERT_PATH", cryptoPath+"/peers/peer0.Rbiexample.com/tls/ca.crt")
