...
public final class AssetTransferTest {
    ...
    class InvokeWriteTransaction {
        ...
        public void transferAssetWhenExistingAssetIsTransferred() {
            ...
            when(ctx.getClientIdentity()).thenReturn(ci);
            when(ci.getMSPID()).thenReturn(TEST_ORG_1_MSP);
            final String recipientOrgMsp = "TestHdfc";
            final String buyerIdentity = "TestHdfcUser";
            Map<String, byte[]> m = new HashMap<>();
    ...
    private static final String TEST_ORG_1_MSP = "TestRbi";
    private static final String TEST_ORG_1_USER = "testRbiUser";
    ...
    private static final byte[] DATA_ASSET_1_BYTES = "{ \"objectType\": \"testasset\", \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"testRbiUser\", \"appraisedValue\": 300 }".getBytes();
}
