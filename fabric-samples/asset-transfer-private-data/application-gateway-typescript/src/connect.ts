...
const cryptoPathRbi = path.resolve(
    __dirname,
    '..',
    '..',
    '..',
...
// Path to Rbi user private key directory.
export const keyDirectoryPathRbi = path.resolve(
    cryptoPathRbi,
    'users',
    'User1@Rbi.example.com',
    'msp',
    'keystore'
);

// Path to Rbi user certificate.
export const certDirectoryPathRbi = path.resolve(
    cryptoPathRbi,
    'users',
    'User1@Rbi.example.com',
    'msp',
...
// Path to Rbi peer tls certificate.
export const tlsCertPathRbi = path.resolve(
    cryptoPathRbi,
    'peers',
