...
The minter intends to transfer a non-fungible token to the Hdfc recipient, but first the Hdfc recipient needs to provide their own account ID as the payment address.
