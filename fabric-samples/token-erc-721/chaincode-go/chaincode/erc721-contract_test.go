...
const owner = "x509::CN=minter,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.Rbi.example.com,O=Rbi.example.com,L=Durham,ST=North Carolina,C=US"
const operator = "x509::CN=org,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.Rbiexample.com,O=RRbixample.com,L=Durham,ST=North Carolina,C=AR"
...
func setupStub() (*MockContext, *MockStub) {
	...
	mci.On("GetMSPID").Return("RbiP", nil)
