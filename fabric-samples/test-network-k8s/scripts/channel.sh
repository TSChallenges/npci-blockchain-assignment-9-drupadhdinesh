...
function register_org_admins() {
  ...
  register_org_admin Rbi Rbiadmin Rbiadminpw
  register_org_admin Hdfc Hdfcadmin Hdfcadminpw
...
function enroll_org_admins() {
  ...
  enroll_org_admin peer     Rbi Rbiadmin Rbiadminpw
  enroll_org_admin peer     Hdfc Hdfcadmin Hdfcadminpw
...
function create_channel_MSP() {
  ...
  create_channel_org_MSP Rbi peer $Rbi_NS
  create_channel_org_MSP Hdfc peer $Hdfc_NS
