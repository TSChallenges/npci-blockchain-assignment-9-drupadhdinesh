...
✅ - Launching chaincode container "localhost:5000/asset-transfer-basic" ...
✅ - Installing chaincode for org Rbi peer peer1 ...
✅ - Installing chaincode for org Rbi peer peer2 ...
...
✅ - Deploying chaincode "asset-transfer-basic" for org Rbi ...
```
...
4. The chaincode docker [image is launched using the yaml template](../kube/Rbi/Rbi-cc-template.yaml) as a Kubernetes 
