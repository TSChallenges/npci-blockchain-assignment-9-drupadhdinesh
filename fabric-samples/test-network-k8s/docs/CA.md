...
kubectl -n test-network apply -f kube/Rbi/Rbi-tls-cert-issuer.yaml
kubectl -n test-network apply -f kube/Hdfc/Hdfc-tls-cert-issuer.yaml
```
...
kubectl -n test-network apply -f kube/Rbi/Rbi-ca.yaml
kubectl -n test-network apply -f kube/Hdfc/Hdfc-ca.yaml
```
