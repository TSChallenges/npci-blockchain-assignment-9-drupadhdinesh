...
export MSP_ID=${MSP_ID:-RbiMSP}
export CRYPTO_PATH=${CRYPTO_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/Rbi}
export KEY_DIRECTORY_PATH=${KEY_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/Rbi/users/Rbiadmin/msp/keystore}
export CERT_DIRECTORY_PATH=${CERT_DIRECTORY_PATH:-../../test-network-k8s/build/enrollments/Rbi/users/Rbiadmin/msp/signcerts}
export TLS_CERT_PATH=${TLS_CERT_PATH:-../../test-network-k8s/build/channel-msp/peerOrganizations/Rbi/msp/tlscacerts/tlsca-signcert.pem}
export PEER_ENDPOINT=${PEER_ENDPOINT:-Rbi-peer1.localho.st:443}
export PEER_HOST_ALIAS=${PEER_HOST_ALIAS:-Rbi-peer1.localho.st}
