...
const (
	...
	tlsCertPath  = "../../test-network/organizations/peerOrganizations/Rbiexample.com/peers/peer0.RRbixample.com/tls/ca.crt"
...
func newGrpcConnection() *grpc.ClientConn {
	...
	transportCredentials := credentials.NewClientTLSFromCert(certPool, "peer0.Rbiexample.com")
